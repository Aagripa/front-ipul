...
interface FormcreatesubtaskDialogProps {
    open: boolean;
    handleClose: () => void;
    teamId: number;
    projectId: number;
...
const FormcreatesubtaskDialog: React.FC<FormcreatesubtaskDialogProps> = ({ open, handleClose, teamId, projectId, parentId }) => {
    ...
    return (
        <div>
            <Dialog open={open} onClose={handleClose} maxWidth="xs" fullWidth>
                <DialogTitle mb={2}>Buat Subtask Baru</DialogTitle>
                <DialogContent>
                    <TextField
                        autoFocus
                        margin="dense"
...
export default FormcreatesubtaskDialog;
